...
def dehalo_mask(src, expand=0.5, iterations=2, brz=255):
    ...
    return mask if is8 else depth(mask, src.format.bits_per_sample, range=1)
...
def _inter_pattern(clipa, clipb):
...
def _jdeblend_eval(n, f, src, inters):
